...
def draw_text():
    screen.draw.text("Level " + str(level), (0, 0), color="white")
    screen.draw.text("Score " + str(score), (100, 0), color="white")
    screen.draw.text("Lives " + str(lives), (200, 0), color="white")
...
def create_bombs():
    if random.randint(0, 100 - level * 4) == 0:
